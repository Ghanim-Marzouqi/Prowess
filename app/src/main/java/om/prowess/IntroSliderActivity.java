...
public class IntroSliderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.Theme_Prowess_NoActionBar);
    ...
    private void addBottomDots(int position) {
        ...
        int colorActive = ContextCompat.getColor(IntroSliderActivity.this, R.color.primary);
        int colorInactive = ContextCompat.getColor(IntroSliderActivity.this, R.color.secondary);
        dotsLayout.removeAllViews();
        for(int i = 0; i<dots.length; i++) {
            dots[i] = new TextView(this);
            dots[i].setText(Html.fromHtml("&#8226;", HtmlCompat.FROM_HTML_MODE_LEGACY));
